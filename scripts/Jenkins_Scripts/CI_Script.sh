...
sdk_E2e_Tests() {
        ...
        echo "#########################################"
        echo -e "\033[32m Run test-headless" "\033[0m"
        echo "#########################################"
        ...
        echo "#################################################"
        echo -e "\033[32m------> Run gulp test-e2e" "\033[0m"
        echo "##################################################"
        ...
        echo "##########################################"
        echo "\033[32m-------> Tests Complete" "\033[0m"
        echo "##########################################"
}
...
publish_Api_Docs() {
        echo
        echo "-----------> Publish Chaincode_Node_SDK API docs after successful merge on amd64"
        ./Publish_API_Docs.sh
}
Parse_Arguments $@
