...
// needed to install @types/node, @types/googlebuf, @types/winston
// in both package.json in src and in root
declare module 'fabric-shim' {
    ...
    export namespace Iterators {
        ...
        //TODO: Should autogen these from the protos
        interface KV {
            key: string;
            value: Buffer;
            getKey(): string;
    ...
    //TODO: This def is correct, but possibly not complete
    ...
    // We should auto generate this from the protobufs
    // maybe even store it as a separate type file ?
    export namespace ChaincodeProposal {
        ...
        // TODO: why are these interfaces and not types ? you can interchange, interfaces are more flexible
        interface Header {
