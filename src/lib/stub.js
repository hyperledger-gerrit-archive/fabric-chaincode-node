...
class ChaincodeStub {
	 ...
	 * [stub.getCreator()]{@link ChaincodeStub#getCreator} can be truested. But in some scenarios, the chaincode needs
	 ...
	 * the event will be delivered to the current event listeners that have been
	 * registered with the peer's event producer.
