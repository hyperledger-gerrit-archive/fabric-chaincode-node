...
gulp.task('clean-up-crypto', gulp.series(() => {
    return gulp.src('*.js', {read: false})
        .pipe(shell([
            util.format('rm -rf %s', path.join(networkDir, 'crypto-material', 'crypto-config')),
            util.format('rm -f %s', path.join(networkDir, 'crypto-material', 'channel.tx')),
            util.format('rm -f %s', path.join(networkDir, 'crypto-material', 'core.yaml')),
            util.format('rm -f %s', path.join(networkDir, 'crypto-material', 'genesis.block')),
            util.format('rm -f %s', path.join(networkDir, 'crypto-material', 'mychannel.block'))
        ]));
}));
