...
gulp.task('query_functions', async (done) => {
    ...
    if (error) {
        ...
        const expectedMetadata = '{"info":{"title":"chaincode","version":"1.0.0"},"contracts":[{"info":{"title":"UpdateValues","version":"1.0.0"},"transactions":[{"name":"unknownTransaction"},{"name":"beforeTransaction"},{"name":"createContext"},{"name":"setup"},{"name":"setNewAssetValue"},{"name":"doubleAssetValue"}],"name":"UpdateValues"},{"info":{"title":"UpdateValues","version":"1.0.0"},"transactions":[{"name":"quarterAssetValue"},{"name":"getAssetValue"}],"name":"RemoveValues"},{"info":{"title":"org.hyperledger.fabric","version":"1.0.0"},"transactions":[{"name":"GetMetadata"}],"name":"org.hyperledger.fabric"}],"components":{}}';

        const schema = fs.readFileSync('../../fabric-contract-api/schema/contract-schema.json');
