...
describe('Handler', () => {
    ...
    describe('ChaincodeSupportClient', () => {
        ...
        describe('handleGetState', () => {
            ...
            before(() => {
                ...
                const payload = new fabprotos.protos.GetState({
                    key,
                    collection
                });
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.GetState.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handlePutState', () => {
            ...
            before(() => {
                const payload = new fabprotos.protos.PutState({
                    key,
                    value,
                    collection
                });
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.PutState.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleDeleteState', () => {
            ...
            before(() => {
                const payload = new fabprotos.protos.DelState({
                    key,
                    collection
                });
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.DelState.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handlePutStateMetadata', () => {
            ...
            before(() => {
                const stateMetadata = new fabprotos.protos.StateMetadata({
                    metakey: metadataKey,
                    value: ep
                });

                const payload = new fabprotos.protos.PutStateMetadata({
                    key,
                    collection,
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.PutStateMetadata.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleGetStateMetadata', () => {
            ...
            before(() => {
                const payload = new fabprotos.protos.GetStateMetadata({
                    key,
                    collection
                });
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.GetStateMetadata.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleGetStateByRange', () => {
            ...
            let expectedMsg;
            before(() => {
                const payload = new fabprotos.protos.GetStateByRange({
                    startKey,
                    endKey,
                    collection
                });
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.GetStateByRange.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleQueryStateNext', () => {
            ...
            let expectedMsg;
            before(() => {
                const payload = new fabprotos.protos.QueryStateNext({
                    id
                });

                expectedMsg = {
                    type: fabprotos.protos.ChaincodeMessage.Type.QUERY_STATE_NEXT,
                    payload: fabprotos.protos.QueryStateNext.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleQueryStateClose', () => {
            ...
            let expectedMsg;
            before(() => {
                const payload = new fabprotos.protos.QueryStateClose({
                    id
                });
        ...
        describe('handleGetQueryResult', () => {
            ...
            let expectedMsg;
            before(() => {
                const payload = new fabprotos.protos.GetQueryResult({
                    query,
                    collection
                });
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.GetQueryResult.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleGetHistoryForKey', () => {
            ...
            let expectedMsg;
            before(() => {
                const payload = new fabprotos.protos.GetHistoryForKey({
                    key
                });

                expectedMsg = {
                    type: fabprotos.protos.ChaincodeMessage.Type.GET_HISTORY_FOR_KEY,
                    payload: fabprotos.protos.GetHistoryForKey.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
        ...
        describe('handleInvokeChaincode', () => {
            ...
            before(() => {
                ...
                const payload = new fabprotos.protos.ChaincodeSpec({
                    chaincodeId,
                ...
                expectedMsg = {
                    ...
                    payload: fabprotos.protos.ChaincodeSpec.encode(payload).finish(),
                    channel_id: 'theChannelID',
                    txid: 'theTxID'
                };
            });
    ...
    describe('handleGetStateMetadata', () => {
        ...
        before(() => {
            ...
            payload = new fabprotos.protos.StateMetadataResult({
                entries
            });

            payload = fabprotos.protos.StateMetadataResult.encode(payload).finish();
        });
