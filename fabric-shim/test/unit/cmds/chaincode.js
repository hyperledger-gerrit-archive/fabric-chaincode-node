...
describe.only('chaincode cmd', () => {
	...
	it ('should handle correctly', () => {
		let myFakePromise = new fakePromise();
		sandbox.stub(Bootstrap, 'bootstrap').returns(myFakePromise);
		...
		expect(argv.thePromise).to.deep.equal(myFakePromise);
	});
});