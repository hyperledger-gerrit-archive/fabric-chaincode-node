...
class ChaincodeFromContract {
    ...
    constructor(contractClasses, serializers, metadata = {}) {
        ...
        // reason for doing this is that th
        ...
        // logger.info('Internal structure : \n', util.inspect(this.contractImplementations, {depth:4}));
    }

    /**
     * Compile the complex object schemas into validator functions that can be used
     * for arguments. Also establish basic validators for the simpler types.
     *
    ...
    _compileSchemas() {
        ...
        schemaList.forEach((e) => {
            const id = e.$id;
            this.contractImplementations.schemas[id.toLowerCase()] = {};
            this.contractImplementations.schemas[id.toLowerCase()].validator = ajv.getSchema(id);
        });
        ...
        for (const contractName in this.contractImplementations) {
            ...
            const dataMarshall = new DataMarshall(requestedSerializer, this.serializers.serializers,  this.contractImplementations.schemas);
    ...
    _resolveContractImplementations(contractClasses) {
        ...
        for (const contractClass of contractClasses) {
            ...
            implementations[name] = {contractInstance : contract, transactions, info};
