...
describe('ECDSA Key', () => {
	...
	it ('should set the value of _key when valid key passed', () => {
		let key = {type: 'EC', prvKeyHex: null, pubKeyHex: 'some random value'};
		let myEcdsaKey = new ecdsaKey(key);
	...
	describe('isPrivate', () => {
		it ('should return true when _key has prvKeyHex', () => {
			let myEcdsaKey = new ecdsaKey({type: 'EC', prvKeyHex: 'some random value', pubKeyHex: 'some random value'});
