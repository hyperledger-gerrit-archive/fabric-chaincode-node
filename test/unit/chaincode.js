...
const Logger = require('../../fabric-shim/lib/shim/logger');

const chaincodePath = '../../fabric-shim/lib/shim/chaincode.js';

const _serviceProto = grpc.load({
	root: path.join(__dirname, '../../fabric-shim/lib/shim/protos'),
