...
// class under test
const pathToRoot = '../../..';
const bootstrap = require(path.join(pathToRoot, 'fabric-shim/contract-spi/bootstrap'));
const Contract = require(path.join(pathToRoot, 'fabric-contract-api/contract'));
const ChaincodeFromContract = require(path.join(pathToRoot, 'fabric-shim/contract-spi/chaincodefromcontract'));
const shim = require(path.join(pathToRoot, 'fabric-shim/shim/chaincode'));
const FarbicStubInterface = require(path.join(pathToRoot,'fabric-shim/shim/stub'));
