...
let Handler = rewire('../../src/shim/handler.js');

const Stub = require('../../src/shim/stub.js');
const MsgQueueHandler = Handler.__get__('MsgQueueHandler');
const QMsg = Handler.__get__('QMsg');
const StateQueryIterator = require('../../src/shim/iterators.js').StateQueryIterator;
const HistoryQueryIterator = require('../../src/shim/iterators.js').HistoryQueryIterator;
...
describe('Handler', () => {
    ...
    describe('ChaincodeSupportClient', () => {
        ...
        describe('chat', () => {
            afterEach(() => {
                Handler = rewire('../../src/shim/handler.js');
            });
