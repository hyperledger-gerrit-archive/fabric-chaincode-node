...
let Handler = rewire('../../fabric-shim/shim/handler.js');

const Stub = require('../../fabric-shim/shim/stub.js');
const MsgQueueHandler = Handler.__get__('MsgQueueHandler');
const QMsg = Handler.__get__('QMsg');
const StateQueryIterator = require('../../fabric-shim/shim/iterators.js').StateQueryIterator;
const HistoryQueryIterator = require('../../fabric-shim/shim/iterators.js').HistoryQueryIterator;
...
describe('Handler', () => {
	...
	describe('ChaincodeSupportClient', () => {
		...
		describe('chat', () => {
			afterEach(() => {
				Handler = rewire('../../fabric-shim/shim/handler.js');
			});
