...
describe('Chaincode clientidentity', () => {
    ...
    it('should create an instance of the client identity class', async function () {
        ...
        expect(payload.mspId).to.equal('Org1MSP', 'Test mspId value');
        expect(payload.id).to.equal('x509::/C=US/ST=California/L=San Francisco/CN=Admin@org1.example.com::/C=US/ST=California/L=San Francisco/O=org1.example.com/CN=ca.org1.example.com', 'Test getID()');
    });
